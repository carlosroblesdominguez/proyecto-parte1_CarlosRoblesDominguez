...
urlpatterns = [
    ...
    # Crear Torneos
    path('torneos/create', views.torneo_create, name='torneo_create'),
    # Buscar Partidos
    path('torneos/buscar/', views.torneo_buscar, name='torneo_buscar'),
    # Actualizar Partidos
    path('torneos/editar/<int:torneo_id>/', views.torneo_editar, name='torneo_editar'),
    # Eliminar Partidos
